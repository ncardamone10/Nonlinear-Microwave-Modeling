...
# file_path = './Assignment/Data From ADS/IV Curves/IV Curves Data for Gm.txt'
...
# Read the data
file_path = './Assignment/Data From ADS/IV Curves/IV Curves Data for Gm.txt'  # Update this path to your data file location
data = pd.read_csv(file_path, sep='\t', engine='python')
